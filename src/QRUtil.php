...
class QRUtil
{
    ...
    {
        $d = $data << 10;
        while (QRUtil::getBCHDigit($d) - QRUtil::getBCHDigit(self::QR_G15) >= 0) {
            $d ^= (self::QR_G15 << (QRUtil::getBCHDigit($d) - QRUtil::getBCHDigit(self::QR_G15)));
        }
    ...
    {
        $d = $data << 12;
        while (QRUtil::getBCHDigit($d) - QRUtil::getBCHDigit(self::QR_G18) >= 0) {
            $d ^= (self::QR_G18 << (QRUtil::getBCHDigit($d) - QRUtil::getBCHDigit(self::QR_G18)));
        }
        return ($data << 12) | $d;
    }
